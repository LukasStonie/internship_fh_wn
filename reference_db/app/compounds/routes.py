...
from app.compounds import bp
from app.models.model import Compound, Lens, Laser, SpectralRange, Resolution, Aperture, Slide, Substrate
...
def index():
    ...
    return render_template('compounds/index.html', compounds=compounds)
...
def new():
    ...
    # if the request method is GET, the user wants to display the form
        ...
        print(request.args)
        return render_template('compounds/new.html', values=request.args, lookup=lookup)
...
def edit(compound_id):
    ...
    # if the request method is GET, the user wants to display the form
        ...
        return render_template('compounds/edit.html', compound=compound, lookup=lookup)
...
def show(compound_id):
    compound = db.session.query(Compound).filter(Compound.id == compound_id).first()
    return render_template('compounds/show.html', compound=compound)

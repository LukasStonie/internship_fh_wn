...
def new():
    ...
    # if the request method is GET, the user wants to display the form
        ...
        return render_template('resources/spectra_types/new.html', values=request.args)
...
def edit(spectrum_type_id):
    ...
    # if the request method is GET, the user wants to display the form
        ...
        return render_template('resources/spectra_types/edit.html', spectrum_type=spectrum_type)

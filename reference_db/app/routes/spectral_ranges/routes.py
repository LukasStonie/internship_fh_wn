...
def new():
    ...
    # if the request method is GET, the user wants to display the form
        ...
        return render_template('resources/spectral_ranges/new.html', values=request.args)
...
def edit(spectral_range_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('resources/spectral_ranges/edit.html', spectral_range=spectral_range)
